...
public interface ServiceRequestMapper {
    ...
    @Select("SELECT id, customer_id, service_type, service_date, hospital_name, department, " +
            "requirement, special_notes, ai_summary, preferred_traits, contact_name, contact_phone, budget, status, " +
    ...
    @Insert("INSERT INTO service_request(customer_id, service_type, service_date, hospital_name, " +
            "department, requirement, special_notes, ai_summary, preferred_traits, contact_name, contact_phone, budget, status, " +
            "created_at, updated_at) VALUES(#{customerId}, #{serviceType}, #{serviceDate}, " +
            "#{hospitalName}, #{department}, #{requirement}, #{specialNotes}, #{aiSummary}, #{preferredTraits}, #{contactName}, " +
