  ...
  <div class="admin-requests-page">
    ...
    <div class="content-card">
      ...
      >
        ...
        <el-table-column prop="customerId" label="客户ID" width="90" align="center" />
        <el-table-column prop="serviceType" label="服务类型" min-width="100">
          <template slot-scope="{ row }">
            <el-tag size="small" type="info">{{ row.serviceType }}</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="hospitalName" label="医院" min-width="130" show-overflow-tooltip />
    ...
    >
      <div class="detail-grid" v-if="current">
        ...
        <div class="detail-item">
          ...
          <span class="detail-value">{{ current.customerId }}</span>
        </div>
        <div class="detail-item">
        ...
        <div class="detail-item">
          ...
          <span class="detail-value">{{ current.budget ? '¥' + current.budget : '未设置' }}</span>
        </div>
        <div class="detail-item">
        ...
        <div class="detail-item">
          ...
          <span class="detail-value">{{ formatDate(current.createdAt || current.created_at) }}</span>
        </div>
